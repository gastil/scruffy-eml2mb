            ...
            <xsl:choose>
                <xsl:when test="attributeList">
                    ...
                    <xsl:for-each select="attributeList/attribute">
                        ...
                        <xsl:variable name="super_type">unspecified</xsl:variable>
                        <xsl:variable name="data_type">u</xsl:variable>
                        <xsl:variable name="variable_type">unspecified</xsl:variable>
                        <xsl:variable name="numeric_type">unspecified</xsl:variable>
              ...
              __. attributeLabel 
               ...
               5. description. -->
                        <xsl:value-of select="normalize-space(attributeDefinition)"/>
                        <xsl:value-of select="$delimiter"/>
               ...
               24. dateTimePrecision     -->
                ...
                30. value_codes_XML. a forest, these are enumeratedDomain -->
                        <xsl:choose>
                            <xsl:when
                                test="measurementScale/nominal/nonNumericDomain/enumeratedDomain/codeDefinition">
                                <xsl:for-each
                                    select="measurementScale/nominal/nonNumericDomain/enumeratedDomain/codeDefinition"
                                        >&lt;codeDefinition&gt;&lt;code&gt;<xsl:value-of
                                        select="code"/>&lt;/code&gt;&lt;definition&gt;<xsl:value-of
                                        select="normalize-space(definition)"
                                    />&lt;/definition&gt;&lt;/codeDefinition&gt;</xsl:for-each>
                            </xsl:when>
                            <xsl:when
                                test="measurementScale/nominal/nonNumericDomain/enumeratedDomain/externalCodeSet">
                                <xsl:for-each
                                    select="measurementScale/nominal/nonNumericDomain/enumeratedDomain/externalCodeSet"
                ...
                6. Unit -->
                 ...
                 9. numeric type -->
                        <xsl:value-of select="$numeric_type"/>
                        <xsl:value-of select="$delimiter"/>


                        <!--      
                
                 9. TO DO Bounds XML. bounds are 0:many. could be under numericDomain or dateTimeDomain. min and max are both 0:1
                         <bounds>
